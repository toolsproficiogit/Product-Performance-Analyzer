...
export const processFile = async (file: File): Promise<AnalysisResult> => {
  ...
  return {
    ...
    brandPerformance,
    devicePerformance,
    potentialProducts: topPotential,
    overspendingProducts: topOverspending
  };
};
